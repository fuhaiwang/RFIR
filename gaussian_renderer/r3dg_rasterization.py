...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.computer_pseudo_normal,  # 计算法向量吗？
        ...
        if raster_settings.debug:
            ...
            num_rendered, num_contrib, color, opacity, depth, feature, normal, surface_xyz, weights, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(    # rasterize_points => RasterizeGaussiansCUDA > CudaRasterizer::Rasterizer::forward
                *args)
        ...
        if raster_settings.debug:
            ...
            try:
                grad_means2D, grad_colors_precomp, grad_opacities, grad_means3D, grad_features, grad_cov3Ds_precomp, \
                    grad_sh, grad_scales, grad_rotations = _C.rasterize_gaussians_backward(*args)   # 调用CUDA的算法，返回各种梯度
            except Exception as ex:
