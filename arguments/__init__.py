...
class OptimizationParams(ParamGroup):  # 训练的参数
    def __init__(self, parser):
        self.iterations = 10_000  # 30_000   
        # self.RF_iterations = 2_000
        self.S_Tx = 1.0
        ...
        self.roughness_lr = 0.1 # useless
        self.reflection_coe_lr = 0.1
        self.reflection_phase_lr = 0.1
        self.light_lr = 0.001
        ...
        self.d_r_init = 1e-4
        self.d_r_final = 2e-6
        self.d_lr_delay_mult = 0.3
        self.d_lr_max_steps = 15_000


        # self.percent_dense = 0.001
        self.percent_dense = 0.01 # classroom 0.0005
        ...
        self.densify_grad_threshold = 0.0002  # classroom 
        ...
        self.lambda_normal_render_depth = 0.0  # 0.01
...
class OptimizationDeformParams(ParamGroup):
    def __init__(self, parser):
        self.iterations = 10_000  # 30_000   
        # self.RF_iterations = 2_000
        self.S_Tx = 1.0
        ...
        # v43
        self.d_r_init = 2e-4        # ↑ 2x
        self.d_r_final = 5e-6       # ↑ 2.5x
        self.d_lr_delay_mult = 0.5
        self.d_lr_max_steps = 40_000
