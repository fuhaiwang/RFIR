...
int CudaRasterizer::Rasterizer::forward(
	...
	const int P/*3D Gaus number*/, const int S, int D/*active_sh_degree_，only used by preprocess*/, int M/*Sum of dc and rest harmonics (1+15)*/,
	const float* background,
	const int width, int height,
	const float* means3D,
	const float* shs,
	const float* colors_precomp, //RF
...
void CudaRasterizer::Rasterizer::backward(
	const int P, int S, int D, int M, int R, //my
	const float* background,
	const int width, int height,
	const float* means3D,
	const float* shs,
	const float* features, //my
	...
	float* dL_dmean2D,  // error  wrong
	float* dL_dconic,
	float* dL_dopacity,
	float* dL_dcolor,
	float* dL_dfeature, //my
	float* dL_dmean3D,
	float* dL_dcov3D,
	float* dL_dsh,
	float* dL_dscale,
